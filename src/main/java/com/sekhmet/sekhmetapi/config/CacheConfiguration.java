...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            createCache(cm, com.sekhmet.sekhmetapi.domain.User.class.getName() + ".authorities");
            createCache(cm, com.sekhmet.sekhmetapi.domain.Chat.class.getName());
            createCache(cm, com.sekhmet.sekhmetapi.domain.Chat.class.getName() + ".members");
            createCache(cm, com.sekhmet.sekhmetapi.domain.Chat.class.getName() + ".messsages");
            createCache(cm, com.sekhmet.sekhmetapi.domain.Message.class.getName());
            createCache(cm, com.sekhmet.sekhmetapi.domain.ChatMember.class.getName());
