...
import { getEntity, deleteEntity } from './chat-member.reducer';

export const ChatMemberDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  const confirmDelete = () => {
    dispatch(deleteEntity(chatMemberEntity.id));
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalFooter>
        ...
        <Button id="jhi-confirm-delete-chatMember" data-cy="entityConfirmDeleteButton" color="danger" onClick={confirmDelete}>
...
export default ChatMemberDeleteDialog;
