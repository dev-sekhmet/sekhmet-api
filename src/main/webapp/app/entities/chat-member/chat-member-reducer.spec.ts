...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CHATMEMBER_LIST actions', async () => {
    ...
    it('dispatches CREATE_CHATMEMBER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CHATMEMBER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CHATMEMBER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CHATMEMBER actions', async () => {
      const expectedActions = [
        {
