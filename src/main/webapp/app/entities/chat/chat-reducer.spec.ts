...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CHAT_LIST actions', async () => {
    ...
    it('dispatches FETCH_CHAT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CHAT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CHAT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CHAT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CHAT actions', async () => {
      const expectedActions = [
        {
